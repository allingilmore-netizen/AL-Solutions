...
function PrimaryButton({ children, href, onClick, fullWidth = false }: { children: React.ReactNode; href?: string; onClick?: () => void; fullWidth?: boolean }) {
    ...
    <main style={{ minHeight: '100vh', background: BRAND.deepBg, color: BRAND.text, fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <section style={{ position: 'relative', overflow: 'hidden', padding: '80px 20px 100px' }}>
        <div
          style={{
            ...
            width: '60%',
            height: '100%',
            background: `radial-gradient(ellipse at top right, rgba(4, 120, 87, 0.15), transparent 60%)`,
            pointerEvents: 'none',
          }}
        />
        <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative' }}>
          <div style={{ maxWidth: 700 }}>
            ...
            <p style={{ fontSize: '1.15rem', color: BRAND.muted, lineHeight: 1.7, marginBottom: 36, maxWidth: 600 }}>
              A ledger-grade billing engine for AI voice and SMS agencies. Authorize before spend, settle after completion,
              auto-refill wallets, and pause clients on payment failure—automatically.
            </p>
      ...
      <section style={{ padding: '80px 20px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <SectionHeader
            ...
            subtitle="If you're billing for AI minutes or SMS, you've probably lost money to at least one of these."
          />
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 20 }}>
            {[
              ...
              { icon: '⚠️', title: 'Disputes with no paper trail', desc: '"I never authorized that." Without a ledger, you can't prove anything.' },
      ...
      <section style={{ padding: '80px 20px', background: 'rgba(15, 23, 42, 0.3)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <SectionHeader
            tag="How It Works"
            title="Four-Step Flow"
            subtitle="Every transaction recorded. No revenue left on the table."
          />
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 16 }}>
            {[
              ...
              { step: '04', title: 'Pause on Failure', desc: 'Payment fails? Services pause immediately. Alert fires. No more postpaid exposure.', color: BRAND.muted },
            ].map((item, i) => (
              <div
                key={i}
                style={{
                  background: `linear-gradient(135deg, ${item.color}22, ${BRAND.cardBg})`,
      ...
      <section style={{ padding: '60px 20px', borderTop: `1px solid ${BRAND.cardBorder}`, borderBottom: `1px solid ${BRAND.cardBorder}` }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: 12 }}>
            {['Vapi (Voice)', 'Retell (Voice)', 'Twilio (SMS)', 'Telnyx (SMS)', 'Stripe (Billing)'].map((name) => (
      ...
      <section style={{ padding: '80px 20px' }}>
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          <SectionHeader
            ...
            subtitle="Click each to understand what these systems actually do for your business."
          />
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <Accordion title="What is a ledger?">
              <p style={{ marginBottom: 12 }}>A ledger is like your agency's financial memory. Every credit added, every minute used, every refund issued—recorded permanently with timestamps and IDs.</p>
              <p style={{ marginBottom: 12 }}><strong style={{ color: BRAND.white }}>Why it matters:</strong> When a client disputes a charge, you can show exactly what happened, when, and why. No guesswork. No "he said, she said."</p>
            ...
            <Accordion title="Why idempotency matters">
              <p style={{ marginBottom: 12 }}>Webhooks (the messages that tell your system "a call happened") can fire multiple times due to retries. Without protection, you'd bill the same call twice—or ten times.</p>
              <p style={{ marginBottom: 12 }}><strong style={{ color: BRAND.white }}>Idempotency</strong> means: no matter how many times the same event arrives, it's only processed once. We track event IDs, timestamps, and signatures.</p>
            ...
            <Accordion title="What happens when a payment fails?">
              ...
              <p style={{ marginBottom: 12 }}><strong style={{ color: BRAND.white }}>Our approach:</strong> The moment Stripe reports a failed charge, the client's account is paused. They can't make calls or send messages until payment clears.</p>
              <p style={{ marginBottom: 12 }}>You get an alert. They get a notification. Services resume automatically once payment succeeds.</p>
              <p style={{ color: BRAND.emeraldLight, fontWeight: 600 }}>Zero manual intervention. Zero postpaid exposure.</p>
            </Accordion>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '80px 20px', background: 'rgba(15, 23, 42, 0.3)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <SectionHeader
            ...
            subtitle="Choose based on your team's technical capacity and timeline."
          />
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: 24 }}>
            ...
            <Card>
              ...
              <p style={{ color: BRAND.muted, fontSize: '0.9rem', marginBottom: 24, lineHeight: 1.6 }}>
                Complete technical specification. You build it on your own infrastructure.
              </p>
            ...
            <Card highlight>
              ...
              <p style={{ color: BRAND.muted, fontSize: '0.9rem', marginBottom: 24, lineHeight: 1.6 }}>
                Dedicated stack on our infrastructure. We handle provisioning, monitoring, and maintenance.
              </p>
              <div style={{ marginBottom: 20 }}>
                <p style={{ color: BRAND.white, fontSize: '0.85rem', fontWeight: 600, marginBottom: 10 }}>Best for:</p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 12 }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              <Accordion title="Can this handle inbound calls/messages?" defaultOpen>
                <p><strong style={{ color: BRAND.white }}>Yes, but with nuance.</strong> Inbound usage is harder to pre-authorize. Our system can still log inbound events and deduct credits after—but you won't have "block if no balance" protection. For high-volume inbound, use larger credit buffers.</p>
              </Accordion>
              <Accordion title="Can I connect a provider you don't support?">
                <p><strong style={{ color: BRAND.white }}>Only through our standard APIs.</strong> If your provider can hit <code style={{ color: BRAND.emeraldLight }}>/authorize</code> before usage and send signed events to <code style={{ color: BRAND.emeraldLight }}>/usage/events</code> after, we can track it. We don't build bespoke integrations.</p>
              </Accordion>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              <Accordion title="What does monitoring actually cover?">
                <p><strong style={{ color: BRAND.white }}>Includes:</strong> Workflow health checks, webhook delivery, failed payment alerts, refill verification, ledger audits.</p>
                <p style={{ marginTop: 8 }}><strong style={{ color: BRAND.muted }}>Excludes:</strong> Feature development, provider account management, custom meters, debugging your external systems.</p>
              </Accordion>
            </div>
          </div>
        </div>
      ...
      <section id="apply" style={{ padding: '80px 20px', background: 'rgba(4, 120, 87, 0.08)' }}>
        <div style={{ maxWidth: 600, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <h2 style={{ color: BRAND.white, fontSize: 'clamp(1.75rem, 4vw, 2.25rem)', fontWeight: 700, marginTop: 16, marginBottom: 8 }}>
              Apply for DFY Setup
            </h2>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              <div>
                ...
                <select
                  ...
                  style={{
                    ...
                    border: `1px solid ${BRAND.cardBorder}`,
                    background: 'rgba(2, 6, 23, 0.6)',
                    color: formData.monthlyUsage ? BRAND.white : BRAND.muted,
                    fontSize: '0.95rem',
                    outline: 'none',
                    boxSizing: 'border-box',
                  }}
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Vapi, Twilio, Stripe"
                  style={{
                    width: '100%',
                    padding: '12px 16px',
                    borderRadius: 12,
              ...
              <PrimaryButton fullWidth>Submit Application →</PrimaryButton>
              <p style={{ textAlign: 'center', color: BRAND.muted, fontSize: '0.85rem' }}>
                Or <a href="/billing/offer" style={{ color: BRAND.emeraldLight }}>view full offer details</a> before applying.
              </p>
            </form>
          </Card>
        </div>
