            ...
            <div className="hero-side fade-on-scroll">
              <form id="leadForm" className="lead-form" onSubmit={handleLeadSubmit}>
                ...
                <div className="consent-row">
                  ...
                  <span>
                    Yes, I want to receive marketing texts and special offers from All In
                    Digital. By providing your phone number and opting in, you agree to
                    receive recurring marketing SMS from All In Digital, including
                    promotions, special offers, and updates about our AI phone and SMS
                    systems. Message frequency may vary. Message &amp; data rates may
                    apply. Reply STOP to opt out and HELP for help. Consent is not a
                    condition of purchase. We do not sell or share your mobile number with
          ...
          <div className="modal-card fade-up">
            ...
            <div className="modal-body">
              ...
              <form className="exit-form" onSubmit={handleExitLeadSubmit}>
                ...
                <small>
                  I agree to receive recurring marketing SMS from All In Digital, including
                  promotions, special offers, and updates about our AI phone and SMS
                  systems. Message frequency may vary. Message &amp; data rates may apply.
                  Reply STOP to opt out and HELP for help. Consent is not a condition of
                  purchase. We do not sell or share your mobile number with third parties
