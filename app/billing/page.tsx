        ...
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <Accordion title="What happens when a payment fails?">
              ...
              <p style={{ marginBottom: 12 }}><strong style={{ color: BRAND.white }}>Our approach:</strong> The moment Stripe reports a failed charge, the client account is paused. They cannot make calls or send messages until payment clears.</p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 12 }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              <Accordion title="Can this handle inbound calls/messages?" defaultOpen>
                <p><strong style={{ color: BRAND.white }}>Yes, but with nuance.</strong> Inbound usage is harder to pre-authorize. Our system can still log inbound events and deduct credits after—but you will not have block if no balance protection. For high-volume inbound, use larger credit buffers.</p>
              </Accordion>
              <Accordion title="Can I connect a provider you do not support?">
                <p><strong style={{ color: BRAND.white }}>Only through our standard APIs.</strong> If your provider can hit <code style={{ color: BRAND.emeraldLight }}>/authorize</code> before usage and send signed events to <code style={{ color: BRAND.emeraldLight }}>/usage/events</code> after, we can track it. We do not build bespoke integrations.</p>
              </Accordion>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
